# -*- coding: utf-8 -*-
"""
Created on Tue Jun 14 20:20:31 2022

@author: kalesreg
"""

# Code to read in Wikipedia data
...
nflx_cont_df = nflx_cont_df[["Cur. service", "Title", "Genre", "Premiere", "Seasons", "Status", "Language", "Runtime", "Prev. network(s)"]]
#display(nflx_cont_df)
...
nflx_end_df = nflx_end_df[["Cur. service", "Title", "Genre", "Premiere", "Seasons", "Status", "Language", "Runtime", "Prev. network(s)"]]
#display(nflx_end_df)
...
# Will need to update remove list for headers that don't have tables 
# based on changes to wiki page
hulu_remove = ["Original programming", "Animation", "Unscripted"]
...
# Will need to update remove list for headers that don't have tables 
# based on changes to wiki page
apl_remove = ["Current original programming", "Animation", "Unscripted"]
...
dis_df = dis_df[["Cur. service", "Title", "Genre", "Premiere", "Seasons", "Status", "Language", "Runtime", "Prev. network(s)"]]
#display(dis_df)
...
for entry in range(0, len(all_df)):
    ...
    if str(all_df["Premiere"][entry]) not in ["nan", "TBA", "2022", "2023", "Summer 2022", "Mid 2022", "Late 2022"]:
